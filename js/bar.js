...
var p1Canvas = document.getElementById("p1-money-canvas");
console.log(p1Canvas.width);
console.log(p1Canvas.height);
// p1Canvas.width = p1Canvas.getBoundingClientRect().width;
// p1Canvas.height = p1Canvas.getBoundingClientRect().height;
// console.log(p1Canvas.width);
// console.log(p1Canvas.height);
var p2Canvas = document.getElementById("p2-money-canvas");
...
function displayGameInfo() {
  ...
  p1ctx.fillStyle = "red";
  p1ctx.fillRect(0, 0, moneyHistory[roundNum][0]/10, 25);
  // p1ctx.font = "16px sans-serif";
  // p1ctx.fillText("Team RED Money: " + moneyHistory[roundNum][0], 0, p1Canvas.height/2);

  p2ctx.clearRect(0, 0, p1Canvas.width, p1Canvas.height);
  p2ctx.fillStyle = "blue";
  p2ctx.fillRect(0, 0, moneyHistory[roundNum][1]/10, 25);
  // p2ctx.font = "16px sans-serif";
  // p2ctx.fillText("Team BLUE Money: " + moneyHistory[roundNum][0], 0, p1Canvas.height/2);
